...
// LayoutAnimation handles animating elements that should change size or appear/
// disappear between calls to render.
...
export default class MessagingContainer extends React.Component { 
	static propTypes = {
  	...
  	componentDidMount() {
  		// On Android, when the `CUSTOM` IME is active, we want the back button
  		// to dismiss the IME, just like it would for the device keyboard.
